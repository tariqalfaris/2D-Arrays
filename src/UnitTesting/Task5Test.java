...
public class Task5Test {
    ...
    void testSingleElementMatrixPrintsNothing() {
        Task5.submatrix(new int[][] { {5} }, 0, 0);
        assertEquals("", outContent.toString());
    }

    @Test
    void testSingleRowRemovingItPrintsNothing() {
        Task5.submatrix(new int[][] { {1,2,3} }, 0, 1);
        assertEquals("", outContent.toString());
    }
    ...
    void testRowIndexOutOfRangeThrows() {
        int[][] a = { {1,2,3}, {4,5,6}, {7,8,9} };
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> Task5.submatrix(a, 5, 1));
    }

    @Test
    void testColumnIndexOutOfRangeThrows() {
        int[][] a = { {1,2,3}, {4,5,6}, {7,8,9} };
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> Task5.submatrix(a, 1, 5));
    }

    @Test
    void testNegativeIndexThrows() {
        int[][] a = { {1,2,3}, {4,5,6}, {7,8,9} };
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> Task5.submatrix(a, -1, 1));
    }

    @Test
    void testEmptyArrayThrows() {
        assertThrows(ArrayIndexOutOfBoundsException.class,
                () -> Task5.submatrix(new int[0][0], 0, 0));
    }

    @Test
    void testNullArrayThrows() {
        assertThrows(NullPointerException.class,
                () -> Task5.submatrix(null, 0, 0));
    }
